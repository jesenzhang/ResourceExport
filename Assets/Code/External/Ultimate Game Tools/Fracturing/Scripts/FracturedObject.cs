...
public class FracturedObject : MonoBehaviour
{
    ...
    public float            MinColliderVolumeForBox              = 0.01f;
    ...
    public bool             SplitsWorldSpace                     = false;
    ...
    public bool             ShowChunkColoredState                = false;
    ...
    public Material GizmosMaterial
    {
        get
        {
            ...
            {
                Shader shader = Shader.Find("Alpha double sided");
                m_GizmosMaterial = new Material(shader);
            }
